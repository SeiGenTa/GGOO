        ...
        <Card.Header>
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <Card.Description
                        >Revisa tus tarjetas, sus vencimientos y el estado de
                        cualquier reclamo.</Card.Description
                    >
                </div>
                <Button
                    type="button"
        ...
        <Card.Content class="p-0">
            ...
            >
                <p class="text-muted-foreground">
                    Mostrando página {data.pagination.page} de {data.pagination
                        .totalPages}. Total tarjetas: {data.pagination
                        .totalItems}
                </p>
...
<Dialog.Root bind:open={complaintDialogOpen}>
    <Dialog.Content>
        <Dialog.Header>
            ...
            <Dialog.Description>
                {#if selectedCard}
                    Explica por qué consideras que la tarjeta {selectedCard.tipo}
                    debería revisarse.
                {:else}
            ...
            >
                ...
                <div class="space-y-1">
                    <label
                        ...
                        for="complaint-reason">Razón del reclamo</label
                    >
                    <textarea
                        id="complaint-reason"
                        name="razon"
        ...
        <Dialog.Footer>
            ...
            <Button type="submit" form="complaint-form" disabled={!selectedCard}
...
<Dialog.Root bind:open={helpDialogOpen}>
    <Dialog.Content>
        <Dialog.Header>
            ...
            <Dialog.Description
                >Información rápida sobre el uso de tus tarjetas.</Dialog.Description
            >
        </Dialog.Header>

        <div class="space-y-3 text-sm text-muted-foreground">
            <p>
                Aquí se muestran todas las tarjetas asignadas a tu usuario,
                junto con la razón por la que fueron aplicadas.
            </p>
            <p>
                También puedes ver si una tarjeta ya fue usada o si está
                vencida, para entender su estado actual.
            </p>
            <p>
                Si una tarjeta todavía no tiene reclamo, podrás reclamarla una
                sola vez desde esta misma pantalla.
            </p>
            <p>
                Cuando el administrador responda, la respuesta aparecerá en la
